...
public class JF4 extends javax.swing.JFrame {
    ...
    public class InvalidValueException extends Exception {
     ...
     private void parseAndValidate(String DowbLimit,String UpLimit,String Step,String Result) throws InvalidValueException {
    ...
    private void initComponents() {
        ...
        LoadJson = new javax.swing.JMenuItem();
   ...
   public void saveToJsonFile(File file) throws IOException {
        ...
        for (RecIntegral rec : SaveTable) {
            JSONObject jsonObject = new JSONObject();
            // Заполняем jsonObject данными из rec
            jsonObject.put("DowbLimit", rec.Ret()[0]);
            jsonObject.put("UpLimit", rec.Ret()[1]);
            jsonObject.put("Step", rec.Ret()[2]);
            jsonObject.put("Result", rec.Ret()[3]);
...
public void loadFromJsonFile(File file) throws IOException {
    try (FileReader fileReader = new FileReader(file)) {
        ...
        if (obj instanceof JSONArray) {
            ...
            SaveTable.clear(); // Очистите текущий список перед загрузкой

            for (Object item : jsonArray) {
                if (item instanceof JSONObject) {
                    JSONObject jsonObject = (JSONObject) item;
                    RecIntegral rec = new RecIntegral(
                            (String) jsonObject.get("DowbLimit"),
                            (String) jsonObject.get("UpLimit"),
                            (String) jsonObject.get("Step"),
            ...
            System.err.println("JSON-файл не является массивом.");
        }
    ...
    private void ResultActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ResultActionPerformed
        if (jTable1.getSelectedRow() > -1){
            ...
            try {
                parseAndValidate(jTable1.getValueAt(getRow, 0).toString(),jTable1.getValueAt(getRow, 1).toString(),jTable1.getValueAt(getRow, 2).toString(),String.format("%.5f", Square));
            ...
            } catch (JF4.InvalidValueException e) {
    ...
    private void AddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddActionPerformed
        ...
        try{
            parseAndValidate(DownLimit.getText(), UpLimit.getText(),StepTxt.getText(),"0");
    ...
    private javax.swing.JMenuItem LoadJson;
    ...
    private javax.swing.JMenuItem SaveJson;
